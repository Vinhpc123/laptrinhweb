...
<body>
   ...
   ?>
        <p> <?php echo $fetch_cart['name']; ?>
            <span>(<?php echo 'VNĐ '.$fetch_cart['price']. '/-'.' x '. $fetch_cart['quantity']; ?>)</span>
        </p>
        <?php
      }
   }else{
   ...
   ?>
        <div class="grand-total"> Tổng : <span> <?php echo $grand_total; ?> VNĐ</span> </div>
        ...
        <form action="" method="post">
            ...
            <div class="flex">
                ...
                <div class="inputBox">
                    ...
                    <input type="number" name="number" required placeholder="Vui lòng nhập số điện thoại">
                </div>
                <div class="inputBox">
                    <span>Email :</span>
