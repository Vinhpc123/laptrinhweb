...
?>
    ...
    <div class="form-container">
        ...
        <form action="" method="post">
            <h3>Đăng ký</h3>
            <input type="text" name="name" placeholder="Vui lòng nhập tên" required class="box">
            ...
            <input type="password" name="cpassword" placeholder="Vui lòng nhập lại password" required class="box">
