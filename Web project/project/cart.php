    ...
    <section class="shopping-cart">
      ...
      ?>
            <div class="box">
                ...
                <div class="price">VNĐ <?php echo $fetch_cart['price']; ?>/-</div>
                ...
                <div class="sub-total"> Tổng :
                    <span>VNĐ <?php echo $sub_total = ($fetch_cart['quantity'] * $fetch_cart['price']); ?>/-</span>
                </div>
            </div>
            <?php
      ...
      ?>
        ...
        <div style="margin-top: 2rem; text-align:center;">
            <a href="cart.php?delete_all" class="delete-btn <?php echo ($grand_total > 1)?'':'disabled'; ?>"
                onclick="return confirm('delete all from cart?');">HỦY ĐƠN HÀNG</a>
        </div>

        <div class="cart-total">
            <p>Tổng : <span>VNĐ <?php echo $grand_total; ?>/-</span></p>
            <div class="flex">
